...
const projectsData: readonly Project[] = [
  ...
  },
  {
    ...
    description:
      'Plataforma completa de gestão pessoal e financeira com foco em organização do dia a dia, controle de receitas e gastos, analytics, metas, tarefas e projeções financeiras. Desenvolvido com arquitetura estruturada em PHP, autenticação segura, dashboards analíticos e experiência responsiva para web.',
